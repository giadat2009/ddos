...
████████████████████████████████████████████████████████████████
                         DDos ARMY
    ┌─────────────────────────────────────────────────────────────────────────────┐
    │ version 1.2.8     (-_-)  CODE BY ::Lê Duy Phúc                              │
    │                                                                             │
    │             [!!!Prevent Illegal CC-Attack!!!]                               │
    │ Developer :AKASH.BLACK.HAT                                                  │
    │ Gmail     :Akashram8090as@gmail.com                                         │
    │ YouTube   :https://www.facebook.com/ThangNoNoPC.Profile                     │
    │ Facebook  :https://www.facebook.com/ThangNoNoPC.Profile                     │                      
    │ Instagram :https://www.facebook.com/ThangNoNoPC.Profile                     │
...
def clone():
    ...
    try:
        ...
        f.close()
    print("Socks đã tải xuống thành công!")
...
def prevent():
    ...
    if 'gov' in ip or 'edu' in ip:
        print("Không thể tấn công trang web .gov hoặc .edu!")
        exit()
def main():
    global ip
    global port
